  ...
  return (
    <div style={{minHeight:"100vh",background:"linear-gradient(135deg,#1A0A00 0%,#3D1A00 50%,#1A0A00 100%)",display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"Georgia,serif"}}>
      <div style={{background:"#FDF6EC",borderRadius:16,padding:"48px 40px",maxWidth:420,width:"90%",textAlign:"center",boxShadow:"0 20px 60px rgba(0,0,0,0.5)"}}>
        <div style={{fontSize:42,marginBottom:8}}>\u{1F510}</div>
        ...
        <div style={{position:"relative",marginBottom:16}}>
          ...
          />
          <button onClick={() => setShow(!show)} style={{position:"absolute",right:12,top:"50%",transform:"translateY(-50%)",background:"none",border:"none",cursor:"pointer",fontSize:18}}>{show ? "\u{1F441}" : "\u{1F441}\u200D\u{1F5E8}"}</button>
        </div>
        {error && <p style={{color:"#C0392B",fontSize:13,margin:"0 0 12px"}}>\u26A0 Code incorrect. R\u00e9essayez.</p>}
